namespace EDictionary.Core.Views
{
	partial class frmNormal
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnBritian = new System.Windows.Forms.Button();
			...
			// btnAmerica
			// 
			this.btnAmerica.Location = new System.Drawing.Point(267, 52);
			this.btnAmerica.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.btnAmerica.Name = "btnAmerica";
			this.btnAmerica.Size = new System.Drawing.Size(56, 19);
			this.btnAmerica.TabIndex = 6;
			...
			// btnBritian
			// 
			this.btnBritian.Location = new System.Drawing.Point(334, 52);
			this.btnBritian.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.btnBritian.Name = "btnBritian";
			this.btnBritian.Size = new System.Drawing.Size(56, 19);
			this.btnBritian.TabIndex = 7;
			this.btnBritian.Text = "Britian";
			this.btnBritian.UseVisualStyleBackColor = true;
			this.btnBritian.Click += new System.EventHandler(this.btnBritian_Click);
			// 
			// frmNormal
			// 
			...
			this.Controls.Add(this.btnBritian);
		...
		private System.Windows.Forms.Button btnBritian;
	}
}
